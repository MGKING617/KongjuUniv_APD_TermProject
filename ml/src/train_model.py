...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="ml/artifacts", help="Directory for model and metadata artifacts.")
...
def cross_validate_model(x: pd.DataFrame, y: pd.Series, folds: int) -> dict[str, Any] | None:
    positives = int(y.sum())
    negatives = int(len(y) - positives)
...
def main() -> None:
    ...
    cross_validation = cross_validate_model(x, y, args.cv_folds)
    metrics = {
